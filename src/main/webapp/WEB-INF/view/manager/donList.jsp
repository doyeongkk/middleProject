...
<div id="center"><br>
	<div class="tabs">
      <ul>
         <li class="is-active"><a href="">재능 기부 회원</a></li>
      </ul>
    </div>
...
<div class="profile_edit_container">
      <div class="profile_edit">
       ...
       <table class = "memList" border="1">
  		...
  		<%
  			List<MemberVO> mlist = (List<MemberVO>)request.getAttribute("donmemberlist"); 
	...
	<div class="tabs">
      <ul>
         <li class="is-active"><a href="">재능기부 요청안 조회</a></li>
      </ul>
    </div>
   <div class="profile_edit_container">
   <div class="profile_edit">
        ...
        <table class = "memList" border="1">
  		...
  		<%
  		if(request.getAttribute("donapplylist")!=null){
  			List<DonApplyVO> donalist = (List<DonApplyVO>)request.getAttribute("donapplylist"); 
  			for(DonApplyVO vo2 : donalist) {
  		%>	
  			<tr>
  			<td><%=vo2.getMem_no() %></td>
  			<td><%=vo2.getMem_nm() %></td>
  			<td><%=vo2.getMem_field() %></td>
  			<td><%=vo2.getMem_callmail() %></td>
  			<td rowspan="2"><a href="<%=request.getContextPath() %>/manager/disposeDonApply.do?mem_no=<%=vo2.getMem_no() %>">수락하기</a><br><br><a href="<%=request.getContextPath() %>/manager/deleteDonApply.do?mem_no=<%=vo2.getMem_no() %>">삭제</a></td>
  			</tr>
  			<tr>
  			<th>신청내용</th>	
        	<th cliss = "conten" colspan="3"><%=vo2.getDon_conact() %></th>
        	</tr> 
  		<%
  			}
  			}
