        ...
        <form class="field profile_upload">
          <div class="file is-boxed">
            <label class="file-label">
              ...
              <span class="file-cta">
                <img class="thumbnail_image" src="https://cdn.inflearn.com/public/main/profile/default_profile.png" alt="">
              </span>
            </label>            
          </div>
