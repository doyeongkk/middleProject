...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<div id="band"> 
		...
		<div id = "center">
			<br><br><br>
				<form id = "BoardAddform" method = "post"  action="<%=request.getContextPath() %>/board/BoardAdd.do?board_no=<%=request.getAttribute("board_no")%>">
					<input type="hidden" id="mem_no" name="mem_no" value = "<%=memberVo.getMem_no() %>"/>
					<label>제 목 </label><br>
					<input type='text' id='post_title' name="post_title" size="80%"><br>​<br>
					<label>내용</label><br>
					<textarea rows = "10" cols = "80"  id = "post_cont" name="post_cont"></textarea><br>
